...
public:
	...
	void Draw(D3DXMATRIX vista, D3DXMATRIX proyeccion, D3DXVECTOR3 poscam, float xx, float zz, float posy, float escala,  bool estatico,
		vector2* uv1 = new vector2[2]{0,0}, vector2* uv2 = new vector2[2]{ 0,0 }, vector2* uv3 = new vector2[2]{ 0,0 }, vector2* uv4 = new vector2[2]{ 0,0 }, int frame = 0 )
	{
		posx = xx;
		posz = zz;
		vertices = new VertexComponent[4];
